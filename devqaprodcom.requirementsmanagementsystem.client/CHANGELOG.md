...
- Create Angular project with ng: `ng new devqaprodcom.requirementsmanagementsystem.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`devqaprodcom.requirementsmanagementsystem.client.esproj`).
